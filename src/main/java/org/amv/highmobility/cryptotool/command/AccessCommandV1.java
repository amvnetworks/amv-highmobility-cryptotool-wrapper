...
public class AccessCommandV1 implements Command<Cryptotool.AccessCertificate> {
    ...
    public AccessCommandV1(String issuer, String gainingSerial, String gainingPublicKey, String providingSerial, LocalDateTime startDate, LocalDateTime endDate, String permissions) {
